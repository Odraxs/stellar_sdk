defmodule Stellar.TxBuild.ValidationsTest do
  ...
  test "validate_address/1", %{account_id: account_id} do
    address = SCAddress.new(account: account_id)
    {:ok, ^address} = Validations.validate_address({:address, address})
  end

  test "validate_address/1 error" do
    {:error, :invalid_address} = Validations.validate_address({:address, "invalid"})
  end

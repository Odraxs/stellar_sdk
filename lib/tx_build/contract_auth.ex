defmodule Stellar.TxBuild.ContractAuth do
  ...
  alias StellarBase.XDR.{SCMap, Hash, ContractAuth, SCVec}
  ...
  def sign(
    ...
    {public_key, secret_key} = KeyPair.from_secret_seed(secret_key)
    ...
    public_key_map_entry =
      SCMapEntry.new(
        ...
        SCVal.new(object: SCObject.new(bytes: public_key))
      )
